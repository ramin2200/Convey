...
using System.Linq;
using ReservationCanceled = Pacco.Services.Ecommerce.Core.Events.ReservationCanceled;
using ResourceDeleted = Pacco.Services.Ecommerce.Core.Events.ResourceDeleted;
