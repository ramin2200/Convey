using Pacco.Services.Availability.Core.Template1hg.Events;
using Pacco.Services.Availability.Core.Template1hg.Exceptions;
using Pacco.Services.Availability.Core.Template1hg.ValueObjects;
using System;
using System.Collections.Generic;
using System.Linq;

namespace Pacco.Services.Availability.Core.Template1hg.Entities
{
